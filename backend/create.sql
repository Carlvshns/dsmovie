create table tb_movie (id bigint not null auto_increment, count integer, image varchar(255), score double precision, title varchar(255), primary key (id)) engine=MyISAM;
create table tb_score (value double precision, movie_id bigint not null, user_id bigint not null, primary key (movie_id, user_id)) engine=MyISAM;
